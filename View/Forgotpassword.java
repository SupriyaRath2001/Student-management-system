...
public class Forgotpassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Forgot Password page");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        boolean b=service.ForgotService.Forgotpassword(jTextField1.getText(), jPasswordField1.getText());
        if(b){
            JOptionPane.showMessageDialog(this, "Password update sucessfully");
        }else{
